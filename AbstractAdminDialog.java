...
{
	//定义组件
	private JLabel tableLabel = new JLabel("用户信息列表");//列表标题
	...
	private JLabel nameLabel = new JLabel("用户余额（/元）");
    ...
    //修改功能组件
    protected JTextField updateNumberText = new JTextField(6);//修改编号名称
